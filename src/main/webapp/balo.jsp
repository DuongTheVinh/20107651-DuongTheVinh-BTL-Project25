...
<body>
    ...
    <section id="filters">
        <form method="get" action="${pageContext.request.contextPath}/balo">
            <button type="submit" name="filter" value="">Tất cả Balo</button>
            <c:forEach var="filter" items="${baloFilters}">
    ...
    <section id="products">
        ...
        <div class="product-list">
            <c:forEach var="product" items="${baloProducts}">
