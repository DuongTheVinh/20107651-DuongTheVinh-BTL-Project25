...
<body>
    ...
    <section id="filters">
        <form method="get" action="${pageContext.request.contextPath}/tui-xach">
            <button type="submit" name="filter" value="">Tất cả Túi Xách</button>
            <c:forEach var="filter" items="${tuiXachFilters}">
    ...
    <section id="products">
        ...
        <div class="product-list">
            <c:forEach var="product" items="${tuiXachProducts}">
